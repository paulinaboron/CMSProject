...
<h1>Slajder</h1>
<h2>Id: {id}</h2>
{#await sliderData then sliderData}
    {#if sliderData.error_message}
        {sliderData.error_message}
    {:else}
        {sliderData.name}
        <div
...
>>>>>>> ea0d7db2a12bcda9b7b422d32a3197a5fdea7d6c
